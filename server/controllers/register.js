...
export const register = async (req, res) => {
    ...
    const candidate = await sql`select * from Users where phone = ${phone} limit 1`[0]
    ...
    await sql`insert into Users(FIO, phone, role, password) values(${FIO}, ${phone}, ${userRole[0].role}, ${hashPassword})`
